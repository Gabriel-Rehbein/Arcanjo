...
export default function Explore() {
  ...
  useEffect(() => {
    ...
    loadExplore();
  }, [router.isReady, search, selectedCategory, selectedType, filter]);
  ...
  async function loadExplore() {
    try {
      ...
      if (search) {
        const query = encodeURIComponent(String(search));
        ...
        <main className={styles.explore}>
          ...
          {!loading && error && (
            <div className={styles.error}>
              ...
              <button type="button" onClick={loadExplore}>
                Tentar novamente
              </button>
            </div>
          )}
                ...
                sortedProjects.length ? (
                  <div className={styles.grid}>
                    {sortedProjects.map((project) => {
                      ...
                      const isOwnProject =
                        currentUser && ownerUsername === currentUser;
                      ...
                      <div className={styles.recentList}>
                        {recentSearches.map((term) => (
                          <button
                            ...
                            onClick={() =>
                              router.push(
                                `/explore?search=${encodeURIComponent(term)}`
                              )
                            }
                          >
                            {term}
